...
function TemplatesContent() {
  ...
  const { templates, isLoading, fetchTemplates, deleteTemplate, duplicateTemplate, createTemplate } =
    useTemplatesStore();
        ...
        <div className="grid gap-3">
          {templates.map((template) => (
            <TemplateCard
              ...
              onDuplicate={async () => {
                const clone = await duplicateTemplate(template.id);
                if (clone) router.push(`/templates/${clone.id}`);
              }}
